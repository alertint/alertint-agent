...
| `expected_behavior.review_reminder_interval_days` | int | `30` | Days between standalone reminders to review an active reusable expected schedule after its review date. Accepts 1-365. Review reminders do not expire schedule authority. |
