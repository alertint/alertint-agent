...
- Model-proposed PromQL is parsed locally with the bundled official Prometheus
  parser before reaching Prometheus. Invalid expressions get at most one batch
  repair call capped at 512 output tokens. Only validator-approved, syntax-only
  rewrites are accepted; anything still invalid or meaning-changing is
  discarded, recorded as `invalid`, and treated as inconclusive rather than a
  backend outage. Prometheus `bad_data` query responses remain distinct from
  unrelated backend failures. Normal verification stays at two LLM calls; only
  a malformed query plan adds the repair call. Reported in #62.
...
[Unreleased]: https://github.com/alertint/alertint-agent/compare/v0.13.8...HEAD
...
[0.13.3]: https://github.com/alertint/alertint-agent/compare/v0.13.2...v0.13.3
[0.13.2]: https://github.com/alertint/alertint-agent/compare/v0.13.1...v0.13.2
[0.13.1]: https://github.com/alertint/alertint-agent/compare/v0.13.0...v0.13.1
...
[0.9.1]: https://github.com/alertint/alertint-agent/compare/v0.9.0...v0.9.1
[0.9.0]: https://github.com/alertint/alertint-agent/compare/v0.8.3...v0.9.0
